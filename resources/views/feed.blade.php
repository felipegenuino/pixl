...
<html lang="en">
  ...
  >
    <!-- Navigation -->
    <header class="my-4 hidden sm:flex w-48 shrink-0 flex-col justify-between gap-8 pl-4 xl:ml-32"
    >
    ...
    <!-- Sidebar -->
    <aside class="-mx-4 my-4 hidden lg:flex flex-col w-80 shrink-0 overflow-y-auto px-4"
    >
      <input
        type="text"
